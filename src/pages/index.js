    ...
    return (
      <Layout title="Graviton" location={this.props.location}>
        <div>
          ...
          />
          <div
            style={{ display: "flex", margin: "0 40px", alignItems: "center" }}
          >
            <p style={{ marginBottom: 0, flex: 9 }}>
              A modern <b>code editor.</b>
            </p>
            <Button
              style={{ marginLeft: "40px", marginBottom: 0, flex: 1 }}
